...
#define dirPinMotor1 14
#define stepPinMotor1 12
#define dirPinMotor2 4
#define stepPinMotor2 2
#define laser 25
...
const float kx1=0.2, kx2=0, ky1=0, ky2=0.2, kix1=0.00025, kix2=0, kiy1=0, kiy2=0.00025;//0.05
