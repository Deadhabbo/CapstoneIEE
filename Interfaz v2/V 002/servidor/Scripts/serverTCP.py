...
class ServerTCP(QObject):
    ...
    senal_addres_cliente = pyqtSignal(tuple)
    ...
    def accept_connections(self):
        ...
        thread.senal_aceptado.connect(self.mandar_info_conectado)
        thread.start()
    ...
    def mandar_info_conectado(self, socket_cliente, address):
        self.senal_addres_cliente.emit(address)
